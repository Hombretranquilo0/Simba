...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Banner/Hero Section */}
      <section className="relative rounded-[3rem] p-10 sm:p-20 mb-20 overflow-hidden bg-simba-orange dark:bg-green-900/40 border border-simba-orange/20 shadow-2xl shadow-green-900/20">
        <div className="relative z-10 max-w-3xl">
          ...
          >
            ...
            <p className="text-orange-50/80 dark:text-green-200/60 text-xl mb-12 leading-relaxed max-w-xl font-medium">
        ...
        <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-simba-orange/20 dark:bg-green-400/10 rounded-full blur-3xl animate-pulse" />
